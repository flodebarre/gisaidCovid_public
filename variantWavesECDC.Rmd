...
#  subdat.cases$cases.smoothed <- c(rep(NA, 3), tmp$y, rep(NA, 3))
  ...
  legend("topleft", pch = 15, col = cc.cases[ii.cases], legend = names(cc.cases[ii.cases]), inset = c(0.05, 0))
...
```{r individualPlots, fig.width=7, fig.height=5}
layout(1)
